...
import { updateCondition } from "../../services/conditions";
...
export default function FormDialog(props) {
 ...
 useEffect(() => {
  const { tileData, title, subTitle } = props;
  setTitle(title);
 ...
 const handleSubmit = () => {
  ...
  updateCondition({ conditionId: props._id, data: body, token: localStorage.getItem("token")})
  .then((response) => {
   props.getConditions();
   handleClose();
  })
